...
_parser.add_argument('--project_name',
                     dest='project_name', default='AM_Analyzer', type=str,
...
_parser.add_argument('--train_val_partition',
                     dest='train_val_partition', default=22000, type=int,  # 115200
...
if __name__ == '__main__':
    ...
    if _config.application_mode == "training":
        ...
        rest_service_instance.app.run(host="0.0.0.0", port=4003, debug=False)
