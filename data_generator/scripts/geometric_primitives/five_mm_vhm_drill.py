    ...
    def __init__(self, new_cad_model):
        ...
        self.vectors = {
            "direction_1": {
                ...
                "vector_B": mdc.dvec3(-2.5, 0, -0.0001),
                "vector_C": mdc.dvec3(-2.5, 0, self.pos_z),
                "vector_D": mdc.dvec3(0, 0, self.pos_z + 1.41),
            },
            "direction_2": {
                "vector_A": mdc.dvec3(0, 0, 10.0001 - self.pos_z - 1.41),
                "vector_B": mdc.dvec3(-2.5, 0, 10.0001 - self.pos_z),
                "vector_C": mdc.dvec3(-2.5, 0, 10.0001),
                "vector_D": mdc.dvec3(0, 0, 10.0001),
            },
            "direction_3": {
                "vector_A": mdc.dvec3(0, -0.0001, 0),
                "vector_B": mdc.dvec3(-2.5, -0.0001, 0),
                "vector_C": mdc.dvec3(-2.5, self.pos_z, 0),
                "vector_D": mdc.dvec3(0, self.pos_z + 1.41, 0),
            },
            "direction_4": {
                "vector_A": mdc.dvec3(0, 10.0001 - self.pos_z - 1.41, 0),
                "vector_B": mdc.dvec3(-2.5, 10.0001 - self.pos_z, 0),
                "vector_C": mdc.dvec3(-2.5, 10.0001, 0),
                "vector_D": mdc.dvec3(0, 10.0001, 0),
            },
            "direction_5": {
                "vector_A": mdc.dvec3(-0.0001, 0, 0),
                "vector_B": mdc.dvec3(-0.0001, 0, -2.5),
                "vector_C": mdc.dvec3(self.pos_z, 0, -2.5),
                "vector_D": mdc.dvec3(self.pos_z + 1.41, 0, 0),
            },
            "direction_6": {
                "vector_A": mdc.dvec3(10.0001 - self.pos_z - 1.41, 0, 0),
                "vector_B": mdc.dvec3(10.0001 - self.pos_z, 0, -2.5),
                "vector_C": mdc.dvec3(10.0001, 0, -2.5),
