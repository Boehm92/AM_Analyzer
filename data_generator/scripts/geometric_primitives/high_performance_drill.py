...
class high_performance_drill:
    def __init__(self, new_cad_model):
        ...
        self.max_volume = 608
        self.max_manufacturing_time = 0.38
        ...
        self.vectors = {
            ...
            "direction_2": {
                "vector_A": mdc.dvec3(0, 0, 10.002 - (0.69 + self.pos_z)),
                "vector_B": mdc.dvec3(-2.5, 0, 10.002 - (0.69 + self.pos_z)),
                "vector_C": mdc.dvec3(-4.4, 0, 10.002 - self.pos_z),
                "vector_D": mdc.dvec3(-4.4, 0, 10.002),
            ...
            "direction_4": {
                "vector_A": mdc.dvec3(0, 10.002 - (0.69 + self.pos_z), 0),
                "vector_B": mdc.dvec3(-2.5, 10.002 - (0.69 + self.pos_z), 0),
                "vector_C": mdc.dvec3(-4.4, 10.002 - self.pos_z, 0),
                "vector_D": mdc.dvec3(-4.4, 10.002, 0),
            ...
            "direction_6": {
                "vector_A": mdc.dvec3(10.002 - (0.69 + self.pos_z), -0.001, 0),
                "vector_B": mdc.dvec3(10.002 - (0.69 + self.pos_z), -0.001, -2.5),
                "vector_C": mdc.dvec3(10.002 - self.pos_z, -0.001, -4.4),
                "vector_D": mdc.dvec3(10.002, -0.001, -4.4),
                "vector_E": mdc.dvec3(10.002, -0.001, 0),
